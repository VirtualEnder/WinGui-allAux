  ...
  */
  #define MY_PRIVATE_MIXING "custom_mix.h"
  ...
  */
  ...
  #define SERIAL_SUM_PPM           PITCH,YAW,THROTTLE,ROLL,AUX1,AUX2,AUX3,AUX4,AUX5,AUX6,AUX7,AUX8 //For some Hitec/Sanwa/Others
  ...
  #define OVERRIDE_BUZZERPIN_PINMODE          pinMode (12, OUTPUT); // use A2 instead of d8
  #define OVERRIDE_BUZZERPIN_ON               PORTB |= 1<<6 //PORTB |= 1;
  #define OVERRIDE_BUZZERPIN_OFF              PORTB &= ~(1<<6); //PORTB &= ~1;
  ...
  * http://www.multiwii.com/wiki/index.php?title=LCD_Telemetry */
  ...
  #define VBATSCALE       93 // (*) (**) change this value if readed Battery voltage is different than real voltage
  #define VBATNOMINAL     168 // 12,6V full battery nominal voltage - only used for lcd.telemetry
  #define VBATLEVEL_WARN1  142// (*) (**) 10,7V
  #define VBATLEVEL_WARN2  140 // (*) (**) 9.9V
  #define VBATLEVEL_CRIT   135 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
  #define NO_VBAT          55 // Avoid beeping without any battery
